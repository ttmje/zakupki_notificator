...
async def send_message(message: types.Message):
    await bot.send_message(message.chat.id, f" Последний торг в базе:\n"
                                            ...
                                            f"Ссылка на заказчика 🔗: { 'https://zakupki.gov.ru/' + db.show_last_tender().Ссылка_на_заказчика}\n"
                                            f"Ссылка на закупку 🔗: {'https://zakupki.gov.ru/' + db.show_last_tender().Ссылка_на_закупку}\n"
